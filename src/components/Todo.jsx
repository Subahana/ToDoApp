...
{/*------input box ------*/}
        <div className='flex items-center my-7 bg-purple-100 rounded-full'>
            <input ref = {inputRef}
                className='bg-transparent broder-0 outline-none flex-1 h-14 pl-6 pr-2 placeholder:text-slate-800' 
                type="text" 
                placeholder='Enter ....' 
            />
            <button 
                onClick={add} 
                className='border-none rounded-full bg-purple-500 w-32 h-14 text-white text-lg font-medium cursor-pointer'>ADD +
            </button>
        </div>
{/*------input box ------*/}
        <div>
